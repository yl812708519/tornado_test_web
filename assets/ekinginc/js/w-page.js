;(function($, window, document,undefined) {
    ...
    plugInObj.prototype = {
        ...
        setNumList:function(){
            ...
            * */
            ...
            var isShowPrevEllipsis = currentPage-prevCount-firstCount>1?true:false;
            var isShowNextEllipsis = currentPage+nextCount+lastCount<totalPage?true:false;
            //只显示前省略号 不显示后省略号
    ...
    $.fn.wPage = function(options,data) {
        ...
        // 总页数小于1 不显示分页
        if(!options.totalPage || options.totalPage<=1) return this;
